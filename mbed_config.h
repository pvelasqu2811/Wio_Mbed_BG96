...
#define CLOCK_SOURCE                                                          USE_PLL_HSE_XTAL|USE_PLL_HSI                                                                     // set by target:WIO_BG96
#define CLOCK_SOURCE_USB                                                      0                                                                                                // set by target:WIO_BG96
...
#define MBED_CONF_CELLULAR_USE_APN_LOOKUP                                     0                                                                                                // set by application[*]
...
#define MBED_CONF_NSAPI_DEFAULT_CELLULAR_APN                                  "internet.curiosity.sprint.com"                                                                  // set by application[WIO_BG96]
#define MBED_CONF_NSAPI_DEFAULT_CELLULAR_PASSWORD                             0                                                                                                // set by application[WIO_BG96]
...
#define MBED_CONF_NSAPI_DEFAULT_CELLULAR_USERNAME                             0                                                                                                // set by application[WIO_BG96]
...
#define MODEM_ON_BOARD                                                        1                                                                                                // set by target:WIO_BG96
#define MODEM_ON_BOARD_UART                                                   1                                                                                                // set by target:WIO_BG96
...
#define MBEDTLS_USER_CONFIG_FILE                                              "mbedtls_azure_config.h"                                                                         // defined by application
#define MBED_CONF_TLS_SOCKET_DEBUG_LEVEL                                      1                                                                                                // defined by application
